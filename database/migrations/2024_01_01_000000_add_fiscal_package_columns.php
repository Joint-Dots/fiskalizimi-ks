    ...
    public function up(): void
    {
        ...
        Schema::table($table, function (Blueprint $t) {
            ...
            if (!Schema::hasColumn($t->getTable(), 'atk_transaction_no')) {
                // uint64, as a 20-digit decimal string: its upper half does not
                // fit a signed 64-bit column and would be stored wrapped.
                $t->string('atk_transaction_no', 20)->nullable();
            }
